...
let
  sources = {
    ...
    "restrict-resource-webpack-plugin-1.0.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/restrict-resource-webpack-plugin/-/restrict-resource-webpack-plugin-1.0.0.tgz";
    ...
    "webpack-fail-plugin-1.0.6" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/webpack-fail-plugin/-/webpack-fail-plugin-1.0.6.tgz";
