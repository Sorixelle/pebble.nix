...
let
  ...
  linuxPatches = lib.optionals (!stdenv.isDarwin) [ ./undefined-reference-major.patch ];
in
stdenv.mkDerivation rec {
  ...
  patches = [
    ./apple-silicon-jit-write-protect.patch
    ./memfd-fix.patch
    ./stm32-includes.patch
    ./version-file-rename.patch
  ] ++ linuxPatches;
